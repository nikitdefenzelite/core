...
@section('content')
    @php
         ...
         */
        $breadcrumb_arr = [['name' => 'Cy Scenario Logs', 'url' => 'javascript:void(0);', 'class' => 'active']];
    @endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Cy Scenario Logs</h5>
                            <span>{{ __('List of Cy Scenario Logs') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
