<div class="side-slide" style="right: -100%;">
    <div class="filter">
        ...
        <div class="card-body">
            <form action="{{ route('admin.cy-runners.index') }}" method="GET" id="TableForm" class="d-flex">
                <div class="row">
                    ...
                    <div class="col-12 form-group">
                        ...
                        @php
                            $cyRunner = \App\Models\CyRunner::get();
                            $category = \App\Models\Category::get();
                            $category = $category->where('type_id', \App\Models\Category::STATUS_TYPE_CYPRESS);
                        @endphp
