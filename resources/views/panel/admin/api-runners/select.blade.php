                            ...
                            <div class="d-flex justify-content-end float-right">
                                <div class="runner-controls d-flex justify-content-end float-right">
                                    <a class="btn btn-primary mr-2 d-flex justify-content-center align-items-center"
                                        ...
                                        href="{{ route('admin.api-runners.get-bulk-scenario', ['project_id' => $project->id, 'group_id' => '']) }}">
                                                ...
                                                <div class="col-lg-3 col-md-4">
                                                    <div class="card shadow-md bg-body rounded">
                                                        <div class="card-body d-flex justify-content-between">
                                                            <div class="state">
                                                                 <a href="{{ route('admin.api-runners.get-group-drag-drop-scenario', ['project_id' => $project->id, 'group_id' => $group->id]) }}" class="text-primary">
                                                                    <h3>{{ $groupRunners->count() }}</h3>
                                                                    </a>
                                                                <P class="card-subtitle text-muted fw-500">{{ $group->name }}</P>
                                                            </div>
                                                            <div class="mt-4 cy-run-width">
                                                                <a class="btn btn-primary d-block" title="Flow Runner"
                                                                    target="_blank"
                                                                    href="{{ route('admin.api-runners.get-bulk-scenario', ['project_id' => $project->id, 'group_id' => $group->id]) }}">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                   @php
                                                    ...
                                                    <a class="btn btn-primary mr-2" title="Flow Runner" target="_blank" href="{{ route('admin.api-runners.get-bulk-scenario', ['project_id' => $project->id, 'group_id' => ""]) }}">
                                                        <i class="ik ik-play mr-0"></i>
                                                    </a>
                                                </div>
                                            </div>
