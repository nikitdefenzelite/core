...
@section('content')
    @php
         ...
         */
        $breadcrumb_arr = [['name' => 'Projects', 'url' => 'javascript:void(0);', 'class' => 'active']];
    @endphp
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="dropdown d-flex justicy-content-right">
                            @if (auth()->user()->isAbleTo('add_project'))
                                <a href="{{ route('admin.projects.create') }}" class="btn btn-sm btn-outline-primary mr-2"
                                    title="Add New Project"><i class="fa fa-plus" aria-hidden="true"></i>
                                    {{ __('admin/ui.add') }}
                                </a>
                            @endif
    ...
    @push('script')
        ...
        <script>
                $('#reset').click(function() {
                    fetchData("{{ route('admin.projects.index') }}");
                    window.history.pushState("", "", "{{ route('admin.projects.index') }}");
