    ...
    public function handle()
    {
       ...
       /// Check latest File Changes 
        ...
        if ($connection) {
            ...
            $this->updateTerminalFile('TIMESTAMPS_CORE', $timestamp, $local_project_directory);
...
function processFilesAndCopy($rootPath, $arr, $local_directory, )
{
    ...
    foreach ($arr as $directory) {
        ...
        $this->copyDirectory($directoryPath, $zFolderPath . '/' . $directory, $arr , $local_directory);
    }
...
function copyDirectory($source, $destination, $arr, $local_directory)
{
    ...
    foreach ($iterator as $item) {
        ...
        if ($item->isDir() && in_array($item->getBasename(), $arr)) {
            ...
            $desiredTime = $this->getTerminalFile('TIMESTAMPS_CORE', $local_directory);
