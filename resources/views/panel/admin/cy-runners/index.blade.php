            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{@$project->name}} Cy Scenarios</h5>
                            <span>{{ __('admin/ui.list_of') }} Cy Scenarios</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
    ...
    @push('script')
      ...
      <script>
           $(document).ready(function(){
            ...
            // reset filter start here
                $('#reset').click(function() {
                    fetchData("{{ route('admin.cy-runners.index') }}");
                    window.history.pushState("", "", "{{ route('admin.cy-runners.index') }}");
